...
with open('april_tag_12.csv', mode='w') as csv_file:
    fieldnames = ['Date/time', 'Center']
...
with dai.Device(pipeline) as device:
    ...
    while(True):
        ...
        for aprilTag in aprilTagData:
            ...
            print(idStr,center)
            with open('april_tag_12.csv', mode='a') as csv_file:
                writer = csv.writer(csv_file)
                writer.writerow([datetime.datetime.now(),center])
